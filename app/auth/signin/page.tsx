...
import { AtSign, KeyRound, ArrowLeft, EyeIcon, EyeOffIcon, AlertCircle, Clock } from 'lucide-react';
    ...
    try {
      ...
      if (success) {
        ...
        if (newAttempts >= 5) {
          ...
          setError('Too many failed attempts. Account is temporarily locked for 15 minutes.');
        } else {
        ...
        <div className="w-full max-w-md">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400">Sign in to your CryptoNested account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {searchParams.get('reason') === 'inactivity' && (
                <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 flex items-start">
                  <Clock className="h-5 w-5 text-amber-500 dark:text-amber-400 mt-0.5 mr-3 flex-shrink-0" />
